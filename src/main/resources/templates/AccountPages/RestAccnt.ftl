...
<body>
	...
	<div class="container">
		...
		<form class="form-inline" role="form">
			...
			<button type="button" class="btn btn-default" onclick = "onclickRestAccountPageSubmit(${sessionUserId});">Submit</button>
		</form>
		<br /> <br />
		<div class="col-md-12">
			<form role="form" id="restaurantAccntDetailsForm" >
				<table class="table table-responsive" id="restaurantAccntDetailsTable">
					<thead>
						<tr>
							<th>Line#</th>
							<th>Date</th>
