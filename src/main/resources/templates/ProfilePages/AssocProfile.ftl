...
<script type="text/javascript">
	...
	<#if updateAssocModel.state??>
		if ( '${updateAssocModel.state}' != null ){
			$('#state').val('${updateAssocModel.state}');
			}
	</#if>
	});
</script>
			...
			<div class="col-md-6 col-md-offset-3"
				...
				<div class="form-group" align="center">
					  ...
					  <label class="control-label col-md-2" for="state">State:</label>
					    <div class="col-md-3"> 
							<select name="state" id="state" class="form-control" value= "<#if updateAssocModel.state??>${updateAssocModel.state}</#if>" required>
